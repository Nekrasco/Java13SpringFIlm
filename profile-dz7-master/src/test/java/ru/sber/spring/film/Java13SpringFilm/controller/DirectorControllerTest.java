package ru.sber.spring.film.Java13SpringFilm.controller;
...
public class DirectorControllerTest {
    ...
    public void createUpdateDeleteTestDirector() throws Exception {
        ...
        directorDTO.setDirectorFio("STEVEN SPIELBERG");
        directorDTO.setPosition("GENERAL DIRECTOR");
        ...
        directorDTO1.setDirectorFio("TESTEROV TEST TESTEROVICH UPDATED");
        directorDTO1.setPosition("2022-2023 UPD");
