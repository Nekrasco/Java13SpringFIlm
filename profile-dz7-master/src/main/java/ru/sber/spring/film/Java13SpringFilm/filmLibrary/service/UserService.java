...
import ru.sber.spring.film.Java13SpringFilm.filmLibrary.constants.MailConstants;
...
import ru.sber.spring.film.Java13SpringFilm.filmLibrary.mapper.UserMapper;
...
import ru.sber.spring.film.Java13SpringFilm.filmLibrary.utils.MailUtils;
...
public class UserService extends GenericService<User, UserDTO> {
    ...
    public UserDTO create(UserDTO userDTO) {
        ...
        userDTO.setCreatedWhen2(LocalDate.now());
